...
After fetching the transcript, format it based on what the user asks for. Full templates/examples for each: `references/output-formats.md`.

| Format | Purpose |
| --- | --- |
| Chapters | Timestamped chapter list, grouped by topic shift |
...
4. **Transform** into the requested output format (see table above).
