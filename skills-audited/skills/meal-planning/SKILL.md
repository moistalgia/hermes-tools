...
`meal_week` history records what this household really cooks: something planned
four times in a month is worth suggesting again; something noted as not going
well should not come back a week later. Record outcomes in `notes` or
`fact_record` when someone mentions them.
